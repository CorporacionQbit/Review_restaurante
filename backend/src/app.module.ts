...
{ path: 'users/admin/clients', method: RequestMethod.ALL },
        { path: 'users/admin/owners', method: RequestMethod.ALL },
        { path: 'users/admin/clients/:userId/convert-to-owner', method: RequestMethod.POST },
...
{ path: 'restaurants/:restaurantId/documents/:type', method: RequestMethod.POST },
{ path: 'restaurants/:id/documents', method: RequestMethod.GET },
        ...
        { path: 'restaurants/admin/history', method: RequestMethod.ALL },

        { path: 'restaurants/admin/pending', method: RequestMethod.ALL },
